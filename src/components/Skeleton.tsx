...
// import { PostContent, PostImage } from '../lib/posts';
...
//    <>
//       {isBannerVisible && (
//        <div className= ' fixed lg:left-[50%] lg:top-[-20px]  md:left-[0px]  md:top-[-30px] sm:left-[0px]  sm:w-[70%] sm:top-[150px]  inset-0 bg-black bg-opacity-30 flex z-50  text-white'>

//         <div className='lg:w-[50%] text-black h-full fixed  bg-white   w-[100%] top-[150px] sm:top-0 sm:mt-[120px] '>
