...
const Sidebar = () => {
  ...
  return (
    <div  dir="rtl" id="sidebar" className= {`bg-gray-200  lg:w-full
     px-5 py-8 flex lg:flex-col md:flex-row  items-start  sm:flex-row  h-full  `}>

      <div >
      <h2 className="text-xl font-bold mb-4 text-red-700  ">تفاصيل</h2>

        <div className='bg-white p-[20px] lg:w-full md:w-[300px] sm:w-[650px] sm:flex-row  rounded-lg flex justify-between '>
            <div>
